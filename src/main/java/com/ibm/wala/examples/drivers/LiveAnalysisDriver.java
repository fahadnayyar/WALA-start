...
import com.ibm.wala.examples.analysis.dataflow.LiveAnalysis;
import com.ibm.wala.ssa.IR;

/**
 * An analysis skeleton that simply constructs IRs for all methods in a class hierarchy. Illustrates the use of
 * {@link LiveAnalysis} to TODO: fill.
 */
public class LiveAnalysisDriver {
            ...
            for (IMethod method : klass.getDeclaredMethods()) {
                if (method.getName().toString().compareTo("main")==0) {
                    ...
                    if (ir != null) {
                        ...
                        System.out.println(liveAnalysis.perform(ir));
                    }
